...
//			log.info("Pact State Change >> set register-domain ...");
//			break;
//		case "register-capabilities":
//			log.info("Pact Sate Change >> set register-capabilitiesy ...");
//			break;
//		case "retrieve-product-catalog":
//			log.info("Pact Sate Change >> set retrieve-product-catalog ...");
//			break;
//		}
//
